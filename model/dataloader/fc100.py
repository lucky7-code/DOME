...
IMAGE_PATH1 = osp.join(ROOT_PATH, 'data/FC100/images')
SPLIT_PATH = osp.join(ROOT_PATH, 'data/FC100/split')
...
def get_transforms(size, backbone, s = 1):
    color_jitter = transforms.ColorJitter(0.4 * s, 0.4 * s, 0.4 * s, 0.2 * s)
